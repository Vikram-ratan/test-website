            ...
            <div className="about-sections">
                ...
                <div className="about-right">
                    <div className="about-paragraph">
                        ...
                        <p>My expertise spans identifying trends, optimizing processes, and delivering data-driven solutions that enhance business performance. Passionate about leveraging cutting-edge tools, I thrive on pushing the boundaries of data innovation, whether through predictive modeling, AI applications, or creative visualizations. Outside of work, I’m an extrovert with a love for travel, history, and taking on new adventures—and I also cook a delicious biryani! If you're intrigued by data, creativity, or a good adventure, let’s connect and see where our paths might cross!
                        </p>
                    </div>
